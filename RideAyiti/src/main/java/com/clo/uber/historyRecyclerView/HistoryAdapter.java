package com.clo.uber.historyRecyclerView;
...
public class HistoryAdapter extends RecyclerView.Adapter<HistoryViewHolders> {
    ...
    public HistoryAdapter(ArrayList<com.simcoder.uber.historyRecyclerView.HistoryObject> itemList, Context context) {
